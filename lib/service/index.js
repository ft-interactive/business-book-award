...
function getBethaData() {
  co(function*(){
    var r = yield request('http://bertha.ig.ft.com/view/publish/gss/0Ak6OnV5xs-BudFVqYWZjR3lJWjRYSkZad216UmxKUFE/books');
    if (r.statusCode === 200) {
      console.log('Refreshed data at', (new Date()).toUTCString());
