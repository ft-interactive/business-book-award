...
module.exports = function (options) {
  ...
  app.use(serve(path.resolve(__dirname, options.theme.public), {defer: true}))
  app.use(serve(path.resolve(__dirname, '../node_modules/business-books-of-the-decade-frontend/')))
  ...
  var viewConfig = require(path.resolve(__dirname, options.theme.config));
